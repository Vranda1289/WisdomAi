...
export const ChatLayout = () => {
  ...
  const handleSendMessage = async (messageText) => {
    ...
    try {
      ...
      // Append a friendly local error message from Wisdom AI without losing the user's message
      const errorMsg = {
        role: 'assistant',
        content: "I encountered a gentle perturbation in my thoughts. Could you please try resending your message?",
        isError: true,
        createdAt: new Date().toISOString()
      };
